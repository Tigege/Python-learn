...
maxlen = 150 #截断字数
min_count = 1#去掉低频词，简单降维 #出现次数少于该值的字扔掉。这是最简单的降维方法
...
train_x, test_x, train_y, test_y = train_test_split(data_train, d, test_size=0, random_state=21)
model = Sequential()
