...
data = MoFa.load_data(download=False)
new_data = MoFa.convert2onehot(data)
...
l1 = tf.layers.dense(tfx, 1000, tf.nn.relu, name="l1")
l2 = tf.layers.dense(l1, 900, tf.nn.relu, name="l2")
l3 = tf.layers.dense(l2, 800, tf.nn.relu, name="l23")
l4 = tf.layers.dense(l3, 500, tf.nn.relu, name="l24")
out = tf.layers.dense(l4, 4, name="l3")
